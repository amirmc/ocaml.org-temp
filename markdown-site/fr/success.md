...
-   [Le synchroniseur de fichiers Unison](#unison)
-   [Le client pair-à-pair MLdonkey](#mldonkey)
-   [Le Langage de Modélisation Financière de LexiFi](#lexifi)
-   [Le système de communication distribuée Ensemble](#ensemble)
-   [L'assistant de preuve Coq](#coq)
-   [L'analyseur statique ASTRÉE](#astree)
-   [SLAM](#slam)
-   [FFTW](#fftw)
