...
~~~~
    ...
    # last_two [ `a ; `b ; `c ; `d ] = Some (`c,`d);;- : bool = true
...
~~~~
    ...
    # replicate [`a;`b;`c] 3 = [`a;`a;`a;`b;`b;`b;`c;`c;`c];;- : bool = true
...
Solution
    ...
    # slice [`a;`b;`c;`d;`e;`f;`g;`h;`i;`j] 2 6 = [`c;`d;`e;`f;`g];;- : bool = true
...
~~~~
    ...
    # insert_at `alfa 1 [`a;`b;`c;`d] = [`a;`alfa;`b;`c;`d];;- : bool = true
