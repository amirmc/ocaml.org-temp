...
Compiling complex OCaml programs can greatly be facilitated by dedicated
tools. The popular GNU make can be used. Omake is kind of analog to GNU
make, but has builtin support for the compilation of OCaml and C
targets. For other, possibly simpler, compilation tools see also [the
"build tools" section of the OCaml
Hump](http://caml.inria.fr/cgi-bin/hump.en02dc.html?sort=1&browse=55 "http://caml.inria.fr/cgi-bin/hump.en.cgi?sort=1&browse=55").

-   [Compiling with GNU
    make](compiling_with_gnu_make.html "Compiling with GNU make")
-   [Compiling with
    Omake](compiling_with_omake.html "Compiling with Omake")
