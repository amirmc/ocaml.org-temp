...
-   [The Unison File Synchronizer](#unison)
-   [The MLdonkey peer-to-peer client](#mldonkey)
-   [LexiFi's Modeling Language for Finance](#lexifi)
-   [The Coq Proof Assistant](#coq)
-   [The ASTRÉE Static Analyzer](#astree)
-   [SLAM](#slam)
-   [FFTW](#fftw)
...
[![Jane Street](img/jane-street-blue.jpg)](img/jane-street-blue.jpg)
